!     Last change:  EF   11 Jul 2005    8:48 am
   ...
   CONTAINS
         ...
         DO nf = 1,3
   	    SELECT CASE (nf)
      	    CASE (1) ! Velocidad U
               ...
               CALL getCoefVol(u,DT,nf)       !Coeficientes volumetricos
            ...
            CASE (2) ! Velocidad V
               ...
               ! Discretizacion de la Ecuacion de Cantidad de Movimiento
               !CALL getCoefDominio()
               CALL getCoefVol(v,DT,nf)        !Coeficientes volumetricos
            ...
            CASE (3) ! Velocidad W
               ...
               ! Discretizacion de la Ecuacion de Cantidad de Movimiento
               !CALL getCoefDominio()
               CALL getCoefVol(w,DT,nf)        !Coeficientes volumetricos
	 ...
	 CALL initCoef()
   	 ...
   	 ! Discretizacion de la Ecuacion
         CALL getCoefDominio()
         CALL getCoefVol(T,DT,nf)  !Coeficientes volumetricos
